...
class _RateUserPageState extends State<RateUserPage> {
  ...
  Widget _buildRatingsList(List<dynamic> ratings) {
    return ListView.builder(
      shrinkWrap: true,
      physics:
          NeverScrollableScrollPhysics(), // To disable scrolling within ListView
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          trailing: Row(
            ...
            children: [
              ...List.generate(
                  fullStars, (_) => Icon(Icons.star, color: Colors.amber)),
              if (halfStar == 1) Icon(Icons.star_half, color: Colors.amber),
